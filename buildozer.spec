...
source.include_exts = py,png,jpg,kv,atlas,ttf,txt,xml,java
...
requirements = python3==3.8.5,hostpython3==3.8.5,kivy,kivymd,pillow
...
android.manifest_placeholders = custom_permissions=./manifest/notification_service.xml
